...
class Game {
    ...
    placeBlock() {
        ...
        if (newBlocks.chopped) {
            ...
            let rotationRandomness = 10;
            let rotationParams = {
                delay: 0.05,
                x: newBlocks.plane == 'z' ? ((Math.random() * rotationRandomness) - (rotationRandomness / 2)) : 0.1,
                z: newBlocks.plane == 'x' ? ((Math.random() * rotationRandomness) - (rotationRandomness / 2)) : 0.1,
                y: Math.random() * 0.1,
            };
    ...
    addBlock() {
        ...
        this.newKidOnTheBlock = new Block(lastBlock);
        this.newBlocks.add(this.newKidOnTheBlock.mesh);
        this.blocks.push(this.newKidOnTheBlock);
